...
def run_test_sum_more_cosines():
    ...
    print('       actual:  ', answer)
    print('Test 2 expected:', -.236, '(approximately)')
    print('       actual:  ', sum_more_cosines(0, 5))
    print('Test 3 expected:', -1.1417, '(approximately)')
    print('       actual:  ', sum_more_cosines(7, 10))
    print('Test 4 expected:', 1.124, '(approximately)')
    print('       actual:  ', sum_more_cosines(-2, 0))
...
def run_test_count_sines_from():
    ...
    print('       actual:  ', count_sines_from(0, 4))
    print('Test 3 expected:', 3)
    print('       actual:  ', count_sines_from(4, 8))
    print('Test 4 expected:', 3)
    print('       actual:  ', count_sines_from(-2, 1))
    print('Test 5 expected:', 5)
    print('       actual:  ', count_sines_from(-9, -3))
    print('Test 6 expected:', 2)
    print('       actual:  ', count_sines_from(-3, -2))
...
def run_test_count_sines_vs_cosines():
    ...
    print('       actual:  ', count_sines_vs_cosines(1))
    print('Test 3 expected:', 2)
    print('       actual:  ', count_sines_vs_cosines(2))
    print('Test 4 expected:', 4)
    print('       actual:  ', count_sines_vs_cosines(3))
    print('Test 5 expected:', 6)
    print('       actual:  ', count_sines_vs_cosines(5))
    print('Test 6 expected:', 11)
    print('       actual:  ', count_sines_vs_cosines(10))
