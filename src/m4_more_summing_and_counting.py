...
def run_test_count_cosines_from():
    ...
    expected = 2
    answer = count_cosines_from(3, 9, .75)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
    ...
    expected = 9
    answer = count_cosines_from(3, 12, -2)
    print('Test 1 expected:', expected)
    print('       actual:  ', answer)
...
def run_test_sum_unit_fractions_from():
    ...
    expected = 2.83  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 9)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 3.962  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 29)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = .11111  # This is APPROXIMATELY the correct answer.
